          ...
          <li class="nav-item">
            ...
            <div class="nav-item-wrapper">
              <a class="nav-link label-1" href="{{ route('admin.buyCoins.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="disc"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Moneda</span></span></div>
              </a>
            </div><!-- parent pages-->

            <hr class="navbar-vertical-line" /><!-- parent pages-->
            <div class="nav-item-wrapper">
              <a class="nav-link label-1" href="{{ route('admin.coinsConfig.index', ) }}" role="button" data-bs-toggle="" aria-expanded="false">
                <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="settings"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Coin Conf</span></span></div>
              </a>
            </div><!-- parent pages-->
